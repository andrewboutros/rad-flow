...
#define LANES 40
#define THREADS 4
#define VRF_DEPTH 512
#define MRF_DEPTH 1024
...
#define AXIS_TRANSACTION_WIDTH (AXIS_PAYLOADW + AXIS_STRBW + AXIS_KEEPW + AXIS_IDW + AXIS_DESTW)
#define TUSER_FLAG(bv)  (AXIS_TUSER_RANGE(bv, 0, 0))
#define TUSER_ADDR(bv)  (AXIS_TUSER_RANGE(bv, VRF_ADDRW, 1))
#define TUSER_VRFID(bv) (AXIS_TUSER_RANGE(bv, AXIS_USERW - 1, VRF_ADDRW + 1))
