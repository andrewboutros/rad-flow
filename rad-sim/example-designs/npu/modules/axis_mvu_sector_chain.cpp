...
axis_mvu_sector_chain::axis_mvu_sector_chain(const sc_module_name& name, unsigned int sector_id, RADSimDesignContext* radsim_design)
  ...
  char sector_decoder_name[NAME_LENGTH], inst_interface_name[NAME_LENGTH], sector_ofifo_interface_name[NAME_LENGTH];
  std::string sector_decoder_name_str, inst_interface_name_str, sector_ofifo_interface_name_str;
...
void axis_mvu_sector_chain::RegisterModuleInfo() {
