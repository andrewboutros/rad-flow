...
public:
    ...
    mvu_mop(unsigned int i) { mvu_mop(); this->tag = i; };
    sc_uint<VRF_ADDRW>& operator[] (unsigned int idx) { return vrf_base[idx]; };
    int size() { return 0; };
};
...
public:
    ...
    evrf_mop(unsigned int i) { evrf_mop(); this->tag = i; };
    sc_uint<VRF_ADDRW>& operator[] (unsigned int idx) { return vrf_base[idx]; };
    int size() { return 0; };
};
...
public:
    ...
    mfu_mop(unsigned int i) { mfu_mop(); this->tag = i; };
    sc_uint<VRF_ADDRW>& operator[] (unsigned int idx) { return add_vrf_base[idx]; };
    int size() { return 0; };
};
...
public:
    ...
    ld_mop(unsigned int i) { ld_mop(); this->src_sel = i; };
    sc_uint<VRF_ADDRW>& operator[] (unsigned int idx) { return vrf0_base[idx]; };
    int size() { return 0; };
};
