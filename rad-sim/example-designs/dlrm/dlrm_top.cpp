...
dlrm_top::dlrm_top(const sc_module_name &name, RADSimDesignContext* radsim_design) : design_top(radsim_design) { //}, rst) { //sc_module(name) {
...
dlrm_top::~dlrm_top() {
  ...
  //delete portal_inst; //AKB commenting out to debug end of sim segfault
}