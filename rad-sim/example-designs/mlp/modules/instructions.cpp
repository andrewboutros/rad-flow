...
bool mvm_inst::operator==(const mvm_inst& rhs) {
  return (en == rhs.en) && (jump == rhs.jump) && (reduce == rhs.reduce) && (accum == rhs.accum) &&
         (accum_en == rhs.accum_en) && (release == rhs.release) && (raddr == rhs.raddr) && (last == rhs.last) &&
         (dest_layer == rhs.dest_layer) && (dest_mvm == rhs.dest_mvm);
}
