...
private:
    ...
    // sc_vector<sc_signal<bool>> mem_rd_req_readys_sig;
    // sc_vector<sc_signal<bool>> mem_rd_req_valids_sig;
    // sc_vector<sc_signal<bool>> mem_wr_req_readys_sig;
    // sc_vector<sc_signal<bool>> mem_wr_req_valids_sig;
    ...
    sc_signal<bool> wr_req_data_rdy_sig;
