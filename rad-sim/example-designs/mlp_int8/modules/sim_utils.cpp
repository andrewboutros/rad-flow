...
template ostream& operator<<<sc_int<IPRECISION>>(ostream& o, const data_vector<sc_int<IPRECISION>>& dvector);
...
template data_vector<sc_int<IPRECISION>> operator+<sc_int<IPRECISION>>(const data_vector<sc_int<IPRECISION>>& v1, 
  const data_vector<sc_int<IPRECISION>>& v2);
...
template data_vector<sc_int<IPRECISION>> max<sc_int<IPRECISION>>(const data_vector<sc_int<IPRECISION>>& v1, 
  const data_vector<sc_int<IPRECISION>>& v2);

void sc_trace(sc_trace_file* f, const data_vector<sc_int<IPRECISION>>& dvector, const std::string& s) {
...
template class data_vector<sc_int<IPRECISION>>;

template class init_vector<sc_in<bool>>;
template class init_vector<sc_out<bool>>;
template class init_vector<sc_signal<bool>>;
template class init_vector<sc_in<data_vector<sc_int<IPRECISION>>>>;
template class init_vector<sc_out<data_vector<sc_int<IPRECISION>>>>;
template class init_vector<sc_signal<data_vector<sc_int<IPRECISION>>>>;