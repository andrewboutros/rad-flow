...
class axis_mvu_sector_chain : public sc_module {
 private:
  ...
  std::vector<axis_master_fifo_adapter<data_vector<tb_input_precision>, sc_bv<WIDE_WRITEBACK_BV_WIDTH>>*>
      chain_ofifo_axis_interface;
 ...
 public:
  ...
  axis_mvu_sector_chain(const sc_module_name& name, unsigned int id, unsigned int inst_interface_dataw,
