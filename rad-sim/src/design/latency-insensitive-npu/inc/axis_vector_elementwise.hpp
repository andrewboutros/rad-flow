...
class axis_vector_elementwise : public sc_module {
 private:
 ...
 public:
  ...
  axis_vector_elementwise(const sc_module_name& name, unsigned int inst_interface_dataw,
                          unsigned int wb_interface_dataw, unsigned int ififo_interface_dataw, unsigned int id);
