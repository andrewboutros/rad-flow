...
int MemorySystem::GetRanks() const { return config_->ranks; }

int MemorySystem::GetBankGroups() const { return config_->bankgroups; }

int MemorySystem::GetBanksPerGroup() const { return config_->banks_per_group; }

int MemorySystem::GetRows() const { return config_->rows; }
