...
#define NOC_LINKS_PAYLOAD_WIDTH   166 + 4
...
#define AXIS_DESTW  NOC_LINKS_DEST_WIDTH + RAD_DESTW
#define AXI4_IDW    8
...
#define AXIS_PAYLOADW (AXIS_MAX_DATAW + AXIS_USERW + RAD_DESTW + 1)
...
#define AXIS_RAD(t) t.range(RAD_DESTW + AXIS_MAX_DATAW + AXIS_USERW, AXIS_MAX_DATAW + AXIS_USERW + 1)

#define AXIS_TSTRB(t) t.range(RAD_DESTW + AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW, RAD_DESTW + AXIS_MAX_DATAW + AXIS_USERW + 1)
#define AXIS_TKEEP(t) t.range(RAD_DESTW + AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + AXIS_KEEPW, RAD_DESTW + AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + 1)
#define AXIS_TID(t)   t.range(RAD_DESTW + AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + AXIS_KEEPW + AXIS_IDW, RAD_DESTW + AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + AXIS_KEEPW + 1)
#define AXIS_TDEST(t) t.range(RAD_DESTW + AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + AXIS_KEEPW + AXIS_IDW + AXIS_DESTW - RAD_DESTW, RAD_DESTW + AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + AXIS_KEEPW + AXIS_IDW + 1)
...
//#define AXIS_TDEST(t) t.range(AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + AXIS_KEEPW + AXIS_IDW + AXIS_DESTW - RAD_DESTW, AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + AXIS_KEEPW + AXIS_IDW + 1)
//#define AXIS_RAD(t) t.range(AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + AXIS_KEEPW + AXIS_IDW + AXIS_DESTW, AXIS_MAX_DATAW + AXIS_USERW + AXIS_STRBW + AXIS_KEEPW + AXIS_IDW + AXIS_DESTW - RAD_DESTW + 1)
